      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Catálogo de reprises oficiales RFHE
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-3 mb-3">
          ...
          <div>
            ...
            <form onSubmit={handleBuscar} className="flex gap-2">
              <input
                type="text"
                placeholder="Nombre, código, nivel..."
                value={busqueda}
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b bg-gray-50">
                          ...
                          <th className="text-left p-3 text-sm">Código FEI</th>
                          <th className="text-left p-3 text-sm">Nivel</th>
                          <th className="text-center p-3 text-sm">Año</th>
