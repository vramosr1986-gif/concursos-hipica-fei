...
INSERT INTO reprises (
  ...
  reprise_oficial, descripcion, multiplicador, desviacion, fei_numero
) VALUES (
  '2', 
  'Clásica 1',
  'RFHE-2023-CLA-1',
  ...
  330,
  'CLÁSICA 1 2023',
  'Reprise de doma clásica nivel 1',
  1,
  0,
  'RFHE-2023-CLA-1'
);
...
-- Notas de conjunto
((SELECT id FROM reprises WHERE codigo = 'RFHE-2023-CLA-1'), 101, 'NC1', 'Impresión General (Armonía y presentación, posición y asiento del jinete/amazona, corrección y efecto de las ayudas)', 1, 'nota_conjunto');
